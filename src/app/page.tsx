    ...
    <div className="bg-[url('/MaskGroup.png')] bg-center bg-no-repeat w-screen h-screen flex justify-around items-center font-[var(--font-sans)] bg-[#121214] gap-8">
      <div className="flex flex-col gap-5 max-w-[490px]">
        ...
        <div>
          ...
          <Link href={'/pontos'}><button className="bg-blue-500 border-blue-500 border text-left  px-6 py-3 rounded-lg mt-3 cursor-pointer hover:bg-transparent transition duration-500">Explorar pontos de doação cadastrados</button></Link>
        </div>
      </div>
      <div>
      </div>
